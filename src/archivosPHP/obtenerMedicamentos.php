...
$sql= "SELECT medicamentos.id,nombreMedicamento,cantidad,fechaVencimiento,lote,sucursal,proveedor,tipo_medicamento.etiquetaTipoProducto,usuarios.nombre,fechaIngreso,numeroFactura FROM medicamentos 
INNER JOIN tipo_medicamento ON tipo_medicamento.idTipoProducto = medicamentos.idTipoProducto
INNER JOIN usuarios ON usuarios.id = medicamentos.idUsuario";
